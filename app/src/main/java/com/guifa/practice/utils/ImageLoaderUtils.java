package com.guifa.practice.utils;
...
public class ImageLoaderUtils {
    ...
    private static int placeholderId = R.drawable.ic_home_black_24dp;
    private static int errorId = R.drawable.ic_home_black_24dp;
